...
You can [download this repo as a ZIP](https://github.com/MattiSG/adblock/archive/main.zip) and install the `adblock` script anywhere you want, or use this one-liner:

	sudo mkdir -p /usr/local/bin && sudo curl -\# https://raw.githubusercontent.com/MattiSG/adblock/main/adblock --output /usr/local/bin/adblock && sudo chmod u+x /usr/local/bin/adblock
